...
const conversations = [
  {
    id: 1,
    with: '道下大樹',
    avatar: '/avatars/道下_大樹.jpg',
    lastMessage: '日本の選挙での投票方法と当日の流れを教えてください。',
  },
  {
    id: 2,
    with: '山崎泉',
    avatar: '/avatars/山崎_泉.jpg',
    lastMessage: '期日前投票はどのような仕組みで、どこでできますか？',
  }
]
...
const initialMessages = [
  {
    id: 1,
    from: 'user',
    content: '日本の選挙での投票方法と当日の流れを教えてください。',
    time: '10:30'
  },
  {
    id: 2,
    from: 'company',
    content: '投票所は通常、朝7時から夜8時まで開いています。投票所に着いたら、まず入口で投票所入場券を提示します。もし入場券を紛失した場合でも、受付で身分証明書を見せれば投票できます。入場券を確認すると、職員から投票用紙が渡されます。国政選挙では、比例区と小選挙区の2枚の用紙を受け取ることが多いです。',
    time: '10:35'
  },
]
