    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContentOverlayBlur>
        ...
        <DialogFooter className='flex flex-col gap-2 sm:flex-row sm:gap-0'>
          <Button variant='destructive' onClick={onDelete} className='rounded'>はい</Button>
          <Button variant='outline' onClick={onCancel} className='rounded hover:bg-white/80 hover:text-black'>いいえ</Button>
        </DialogFooter>
      </DialogContentOverlayBlur>
    </Dialog>
  )
